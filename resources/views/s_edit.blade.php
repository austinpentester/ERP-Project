                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="customerName" name="supplierName" required value="{{$data->supplierName}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="mobileNumber" name="mobileNumber" required value="{{$data->mobileNumber}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="gstNo" class="form-label">Gst No</label>
                                        <input type="text" class="form-control" id="gstNo" name="gstNo" value="{{$data->gstNo}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="panNo" class="form-label">Pan No</label>
                                        <input type="text" class="form-control" id="panNo" name="panNo" value="{{$data->panNo}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" id="billingAddress" name="billingAddress" rows="3" required>{{$data->billingAddress}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="shippingAddress" class="form-label required-field">Shipping Address</label>
                                        <textarea class="form-control" id="shippingAddress" name="shippingAddress" rows="3" required>{{$data->shippingAddress}}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="row contact-detail">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control contactPersonName" id="contactPersonName" name="contactPersonName[]" required value="{{$data->contactPersonName}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="contactMobileNumber" class="form-label required-field">Mobile Number</label>
                                                <input type="text" class="form-control contactMobileNumber" id="contactMobileNumber" name="contactMobileNumber[]" required value="{{$data->contactMobileNumber}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="designation" class="form-label required-field">Designation</label>
                                                <input type="text" class="form-control designation" id="designation" name="designation[]" required value="{{$data->designation}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="contactEmail" class="form-label">Email address</label>
                                                <input type="email" class="form-control contactEmail" id="contactEmail" name="contactEmail[]" value="{{$data->contactEmail}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
