            ...
            <div class="container-fluid">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <h5 class="card-title fw-semibold mb-4">Currencies   Details</h5>
                        @if (session('success'))
                    ...
                    <form action="{{ route('insertCurrencies') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="currencies_name" class="form-label required-field">Currencies Name</label>
                                    <input type="text" class="form-control" id="currencies_name" name="Currencies" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
