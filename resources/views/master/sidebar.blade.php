    ...
    <div>
      ...
      <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
        <ul id="sidebarnav">
            ...
            <!-- Parties submenu -->
            <li class="sidebar-item">
                <a class="sidebar-link" href="#" aria-expanded="false" data-toggle="collapse" data-target="#partiesSubmenu" aria-controls="partiesSubmenu">
                    <span>
            ...
            <!-- Inventory submenu -->
            <li class="sidebar-item">
                <a class="sidebar-link" href="#" aria-expanded="false" data-toggle="collapse" data-target="#inventorySubmenu" aria-controls="inventorySubmenu">
                    <span>
            ...
            <!-- Settings submenu -->
            <li class="sidebar-item">
                <a class="sidebar-link" href="#" aria-expanded="false" data-toggle="collapse" data-target="#settingsSubmenu" aria-controls="settingsSubmenu">
                    <span>
                ...
                <ul id="settingsSubmenu" class="collapse sidebar-submenu">
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="#" aria-expanded="false" data-toggle="collapse" data-target="#companySettingsSubmenu" aria-controls="companySettingsSubmenu">
                        ...
                        <ul id="companySettingsSubmenu" class="collapse sidebar-submenu">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="/branch">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="#" aria-expanded="false" data-toggle="collapse" data-target="#mastersSubmenu" aria-controls="mastersSubmenu">
                        ...
                        <ul id="mastersSubmenu" class="collapse sidebar-submenu">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="./payment-modes.html">
