            ...
            <div class="container-fluid">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <h5 class="card-title fw-semibold mb-4">Color  Details</h5>
                        @if(session('success'))
                    ...
                    @endif
                        <form action="{{ route('insertColor') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="color" class="form-label required-field">Color Name</label>
                                        <input type="text" class="form-control" id="color" name="color" aria-describedby="colorHelp" required>
                                    </div>
                                </div>
