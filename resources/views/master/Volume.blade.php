            ...
            <div class="container-fluid">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <h5 class="card-title fw-semibold mb-4">Volume   Details</h5>
                    @if(session('success'))
                    ...
                    @endif
                        <form action="{{ route('insertVolume') }}" method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="exampleInputEmail1" class="form-label required-field">Volume
                                        </label>
                                        <input type="text" class="form-control" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" name="Volume" required>
                                    </div>
                                </div>
