            ...
            <div class="container-fluid">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <h5 class="card-title fw-semibold mb-4">Taxes   Details</h5>
                        @if(session('success'))
                    ...
                    @endif
                        <form action="{{ route('insertTaxes') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="taxesName" class="form-label required-field">Taxes Name</label>
                                        <input type="text" class="form-control" id="taxesName" name="Taxes" required>
                                    </div>
