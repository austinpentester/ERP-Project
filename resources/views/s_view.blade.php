    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4">Supplier Details</h5>
                        <!-- <form id="customerForm" action="{{ route('supplier_upd',['id'=>$data->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf -->
                            <div class="row">
                                <!-- Main Form Fields -->
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="branch" name="branch" value="{{$data->branch}}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="customerName" class="form-label required-field">Supplier Name</label>
                                        <input type="text" class="form-control" id="customerName" name="supplierName" required value="{{$data->supplierName}}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3 form-group">
                                        <label for="email" class="form-label required-field">Email address</label>
                                        <input type="email" class="form-control" id="email" name="email" required value="{{$data->email}}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="website" class="form-label">Website</label>
                                        <input type="text" class="form-control" id="website" name="website" value="{{$data->website}}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="mobileNumber" class="form-label required-field">Mobile Number</label>
                                        <input type="text" class="form-control" id="mobileNumber" name="mobileNumber" required value="{{$data->mobileNumber}}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="gstNo" class="form-label">Gst No</label>
                                        <input type="text" class="form-control" id="gstNo" name="gstNo" value="{{$data->gstNo}}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="panNo" class="form-label">Pan No</label>
                                        <input type="text" class="form-control" id="panNo" name="panNo" value="{{$data->panNo}}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" id="billingAddress" name="billingAddress" rows="3" required readonly>{{$data->billingAddress}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="shippingAddress" class="form-label required-field">Shipping Address</label>
                                        <textarea class="form-control" id="shippingAddress" name="shippingAddress" rows="3" required readonly>{{$data->shippingAddress}}</textarea>
                                    </div>
                                </div>
                                <h4 class="mt-2 mb-3">Contact Details</h4>
                                @foreach ($data2 as $data)
                                <input type="hidden" value="{{$data->id}}" id="" name="cd_id[]">
                                <div id="contactDetailsSection">
                                    <div class="row contact-detail">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="contactPersonName" class="form-label required-field">Contact Person Name</label>
                                                <input type="text" class="form-control contactPersonName" id="contactPersonName" name="contactPersonName[]" required value="{{$data->contactPersonName}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="contactMobileNumber" class="form-label required-field">Mobile Number</label>
                                                <input type="text" class="form-control contactMobileNumber" id="contactMobileNumber" name="contactMobileNumber[]" required value="{{$data->contactMobileNumber}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="designation" class="form-label required-field">Designation</label>
                                                <input type="text" class="form-control designation" id="designation" name="designation[]" required value="{{$data->designation}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="contactEmail" class="form-label">Email address</label>
                                                <input type="email" class="form-control contactEmail" id="contactEmail" name="contactEmail[]" value="{{$data->contactEmail}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
