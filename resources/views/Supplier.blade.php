            ...
            <div class="container-fluid">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <form id="supplierForm" action="{{ route('supplier.details.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <!-- Main Form Fields -->
                                @if ($data!=null)
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="cus_id" class="form-label">Supplier ID :</label>
                                        <label for="cus_id" class="form-label">Sup - {{$data->sup_id+1}}</label>
                                        <input type="hidden" name="sup_id" value="{{$data->sup_id+1}}">
                                    </div>
                                </div>
                            @else
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="cus_id" class="form-label">Supplier ID :</label>
                                        <label for="cus_id" class="form-label">Sup - 1</label>
