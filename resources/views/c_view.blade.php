            ...
            <div class="container-fluid">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <!-- <form id="customerForm" action="{{ route('customer_upd',['id'=>$data->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf -->
                            <div class="row">
                                <!-- Main Form Fields -->
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="customerName" name="customerName" required value="{{$data->customerName}}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
