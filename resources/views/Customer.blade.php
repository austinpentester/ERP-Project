            ...
            <div class="container-fluid">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <form id="customerForm" action="{{ route('customer.details.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <!-- Main Form Fields -->
                                @if ($data !== null)
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <label for="cus_id" class="form-label">Cus - {{$data}}</label>
                            ...
                            @else
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="cus_id" class="form-label">Customer ID :</label>
                                        <label for="cus_id" class="form-label">Cus - 1</label>
